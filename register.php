...
?>
    <span class ="text-danger"><?= $_SESSION['errors']['first'] ?></span>
    <?php
  }
?>
                                    </div>
...
?>
    <span class ="text-danger"><?= $_SESSION['errors']['last'] ?></span>
    <?php
  }
?>
                                    </div>
...
?>
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            ...
                                            <?php
  if(isset($_SESSION['errors']['confirm_possword'])){
?>
    <span class ="text-danger"><?= $_SESSION['errors']['confirm_possword'] ?></span>
    <?php
  }
?>
</div>
